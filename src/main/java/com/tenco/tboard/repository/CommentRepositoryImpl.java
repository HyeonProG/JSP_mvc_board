...
public class CommentRepositoryImpl implements CommentRepository {
	...
	private static final String UPDATE_COMMENT_BY_BOARD_ID = " update comments set content = ? where id = ? and user_id = ? ";
	...
	public void updateComment(Comment comment) {
		...
		try (Connection conn = DBUtil.getConnection()) {
			conn.setAutoCommit(false);
			try (PreparedStatement pstmt = conn.prepareStatement(UPDATE_COMMENT_BY_BOARD_ID)) {
